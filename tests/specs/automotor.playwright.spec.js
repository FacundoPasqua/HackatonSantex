...
// CONFIG
const INPUT_FILE = './tests/data/Automotor.xlsx';
...
let BASE_SHEET_NAME = 'Automotor';
if (isLocalhost) {
  BASE_SHEET_NAME = 'Automotor_Local';
} else if (isPreprod) {
  BASE_SHEET_NAME = 'Automotor_Preprod';
}else if (isTest){
  BASE_SHEET_NAME = 'Automotor_Test';
}
...
if (preguntas.length === 0) {
  ...
  test.describe.serial('Automotor - Procesamiento por Lotes', () => {
